  ...
  .then(data => {
    ...
    data.forEach((article, index) => {
      ...
      link.className = index === 0
        ...
        : 'story block mb-10 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-transform transform hover:-translate-y-1';
      ...
      const textEl = `
        <div class="${'p-6 col-span-2'}">
          ...
          <h3 class="card-title font-bold mb-2">${article.title}</h3>
